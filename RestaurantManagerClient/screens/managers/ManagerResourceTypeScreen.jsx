            ...
            fetch(host + ':' + port + resourceTypeDeleteUrl + id, {
              ...
              .then(data => {
                if (data.error == 'Internal Server Error') {
                  Alert.alert(
                    "Thông báo",
                    "Không thể xóa loại nguyên liệu vì lý do bảo toàn dữ liệu",
                    [
                      {
                        text: "Đóng",
      ...
      >
        ...
        <SafeAreaProvider>
          <View style={ManagerResourceTypeStyle.setupItem}>
            <Text style={ManagerResourceTypeStyle.title}>Thêm nhà kho mới: </Text>
  ...
  updateItemView = () => {
    return (
      ...
      >
        <SafeAreaProvider>
          <View style={ManagerResourceTypeStyle.setupItem}>
            <Text style={ManagerResourceTypeStyle.title}>Cập nhật nhà kho: {this.state.id}</Text>
            <View style={ManagerResourceTypeStyle.setupItemCenterContainer}><Text style={ManagerResourceTypeStyle.error}>{this.state.error}</Text></View>
            <Input
              inputStyle={{ fontSize: this.state.windowWidth / 28 }}
              inputContainerStyle={{ borderRadius: 10, marginTop: '2%', backgroundColor: 'white' }}
            ...
            <Animated.View
              ...
              <SafeAreaProvider>
                ...
                <View style={ManagerResourceTypeStyle.centercontainer}>
                  <Text style={ManagerResourceTypeStyle.title}>Danh sách:</Text>
                  {this.state.flag ?
                    <View>
