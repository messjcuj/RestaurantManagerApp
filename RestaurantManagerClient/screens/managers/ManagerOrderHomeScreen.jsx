        ...
        setTimeout(
          () => {
            ...
            for (const element of dataJson) {
              ...
              if (element.type == 'Đơn hàng bổ sung' && element.status != 'Đã giao hàng') {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20, padding: '5%' }}>
            ...
            <Button title="Xác nhận" onPress={() => { this.setState({ modalOrderAdditionSearch: false }); }} />
          </View>
    ...
    fetch(host + ':' + port + orderListUrl + value, {
      ...
      .then(dataJson => {
        setTimeout(
          () => {
            var getOrder = [];
            if (dataJson.status != 'Đã giao hàng' && dataJson.type == 'Đơn hàng bổ sung')
              getOrder.push(dataJson);
      ...
      <SafeAreaProvider>
          ...
          <View style={ManagerOrderHomeStyle.addExtraItemContainer}>
            ...
            <View style={ManagerOrderHomeStyle.setupItemCenterContainer}>
              {this.state.tabIndex != 2 ?
                ...
                : null}
              <Text style={ManagerOrderHomeStyle.titleResourceDrink}>Thông tin đơn hàng: </Text>
        ...
        {this.state.statusOderDrinkDetail == 'addview' ?
          <View style={ManagerOrderHomeStyle.addExtraItemContainer}>
            <View style={ManagerOrderHomeStyle.setupItemCenterContainer}>
              <View>
                <Text style={ManagerOrderHomeStyle.titleResourceDrink}>Thêm đồ uống vào đơn hàng: </Text>
            ...
            <View style={ManagerOrderHomeStyle.itemMenuContainerTouchable}>
              <View style={ManagerOrderHomeStyle.itemMenuContainerTouchableContentFoodType}>
                ...
                <Text style={ManagerOrderHomeStyle.title}>Danh sách {this.state.outputCategory}:</Text>
      ...
      <SafeAreaProvider>
        ...
        {this.state.statusOderDishDetail == 'addview' ?
          <View style={ManagerOrderHomeStyle.addExtraItemContainer}>
            <View style={ManagerOrderHomeStyle.setupItemCenterContainer}>
              <View>
                <Text style={ManagerOrderHomeStyle.titleResourceDrink}>Thêm món vào đơn hàng: </Text>
      ...
      <SafeAreaProvider>
        ...
        {this.state.statusOderDiningTableDetail == 'addview' ?
          <View style={ManagerOrderHomeStyle.addExtraItemContainer}>
            <View style={ManagerOrderHomeStyle.setupItemCenterContainer}>
              <View>
                <Text style={ManagerOrderHomeStyle.titleResourceDrink}>Thêm bàn vào đơn hàng: </Text>
              </View>
            </View>
            <View style={ManagerOrderHomeStyle.itemMenuContainerTouchable}>
              <View style={ManagerOrderHomeStyle.itemMenuContainerTouchableContentFoodType}>
          ...
          <TabView
            ...
            navigationState={{
              ...
              routes: [
                ...
                { key: 'orderAddition', title: 'Bổ sung' }
              ]
            }}
