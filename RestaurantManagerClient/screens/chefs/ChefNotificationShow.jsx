...
class ChefNotificationShowScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            flag: true,
    ...
    orderDiningTablerenderItem = ({ item }) => (
        <View>
            <View style={ChefNotificationStyle.item}>
                ...
                <View>
                    <Image
                        style={ChefNotificationStyle.logo}
    ...
    orderDrinkDetailView = () => {
        return (
            <SafeAreaProvider>
                <View style={ChefNotificationStyle.addExtraItemContainer}>

                    <View style={ChefNotificationStyle.setupItemCenterContainer}>
                        <Text style={ChefNotificationStyle.titleResourceDrink}>Thông tin đơn hàng: </Text>
                    ...
                    <View style={ChefNotificationStyle.setupItemCenterContainer}>
                        <TouchableOpacity onPress={() => { this.setState({ status: 'homeview' }); this.componentDidMount(); }} >
                            <Image
                                style={ChefNotificationStyle.cancelButton}
    ...
    render() {
        return (
            ...
            <View style={ChefNotificationStyle.container}>
...
export default connect(mapStateToProps)(ChefNotificationShowScreen);