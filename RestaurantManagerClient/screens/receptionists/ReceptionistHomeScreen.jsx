...
class ReceptionistHomeScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20, padding: '5%' }}>
            <View style={ReceptionistHomeStyle.setupItemCenterContainer}></View>
            <View style={ReceptionistHomeStyle.setupItemCenterContainer}><Text style={ReceptionistHomeStyle.error}>{this.state.errorPaymentModal}</Text></View>
            <Text></Text>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20, padding: '5%' }}>
            ...
            <ScrollView nestedScrollEnabled={false}>
              <DropDownPicker
                listMode="SCROLLVIEW"
                style={ReceptionistHomeStyle.setupItemCenterContainerRowOption}
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20 }}>
            ...
            <View style={ReceptionistHomeStyle.setupItemCenterContainer}><Text style={ReceptionistHomeStyle.error}>{this.state.errorModal}</Text></View>
            <Text></Text>
            <Input
              inputStyle={{ fontSize: this.state.windowWidth / 28 }}
              inputContainerStyle={{ backgroundColor: 'white', borderRadius: 10 }}
            ...
            <View style={ReceptionistHomeStyle.setupItemCenterContainer}>
              <TouchableOpacity onPress={() => { this.addToCart(); }}>
                <Image
                  style={ReceptionistHomeStyle.saveButton}
  ...
  renderDiningTableTypeItem = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistHomeStyle.itemDiningTableDetailList}>
        <View>
          {this.state.statusBlankDiningTable ?
            <TouchableOpacity onPress={() => { if (this.state.statusUseDiningTableAdd == false) this.setState({ datasingleDiningTable: item, status: 'foodview' }); else { this.addMoreDiningTableToOrder(item); } }}>
              <Image
                style={ReceptionistHomeStyle.itemDetailListPlus}
        ...
        <View>
          {this.state.statusUseDiningTable ?
            <Image
              style={ReceptionistHomeStyle.itemDiningTableDetailListLogo}
  ...
  renderItemDetailList = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistHomeStyle.itemDetailList}>
        <View>
        ...
        <View>
          <Image
            style={ReceptionistHomeStyle.itemDetailListLogo}
            source={{
  ...
  renderItemDetailOrderFoodList = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistHomeStyle.itemDetailOrderCartList}>
        <View>
          <TouchableOpacity
            onPress={() => {
            ...
            <Image
              style={ReceptionistHomeStyle.itemDetailOrderListPlus}
              source={require('./../../assets/plus.png')}
            />
          </TouchableOpacity>
          <Text></Text>
        ...
        <View>
          <Image
            style={ReceptionistHomeStyle.itemDetailOrderListLogo}
            source={{
  ...
  renderItemDetailOrderDiningTableList = ({ item }) => (
    <TouchableOpacity onPress={() => { this.checkBoxAddDiningTable(item) }}>
      <View style={ReceptionistHomeStyle.itemDetailOrderList}>
        <Checkbox
  ...
  orderDiningTablerenderItem = ({ item }) => (
    <View>
      <View style={ReceptionistHomeStyle.item}>
        <View>
  ...
  OrderDishView = () => {
    return (
      <Animated.View
        style={[
          ReceptionistHomeStyle.container,
          {
          ...
          <View style={ReceptionistHomeStyle.bottomcontainer}>
            ...
            <View style={ReceptionistHomeStyle.itemMenuContainerTouchable}>
              <View style={ReceptionistHomeStyle.itemMenuContainerTouchableContentFoodType}>
                ...
                <Text style={ReceptionistHomeStyle.title}>Danh sách:</Text>
        ...
        <View style={ReceptionistHomeStyle.setupItemCenterContainer}>
          ...
          >
            <Image
              style={ReceptionistHomeStyle.cart}
  ...
  BillView = () => {
    return (
      <View style={ReceptionistHomeStyle.container}>
        <SafeAreaProvider>
          <View style={{ width: '100%', height: '100%', padding: '2%', borderWidth: 0.3 }}>

            <View style={ReceptionistHomeStyle.itemDetailOrderListExtraContainer}>
            ...
            <View style={ReceptionistHomeStyle.itemDetailOrderListExtraContainer}>
              <TouchableOpacity onPress={() => { this.componentDidMount(); this.setState({ inputPriceCustomer: '', outputPriceResidual: '', status: 'orderdetails' }) }}>
                <Image
                  style={ReceptionistHomeStyle.itemDetailOrderListnextButton}
                  source={require('./../../assets/cancel.png')}
                />
              </TouchableOpacity>
            </View>
    ...
    return (
      <View style={ReceptionistHomeStyle.container}>
                ...
                <View style={ReceptionistHomeStyle.bottomcontainer}>
                  <View style={ReceptionistHomeStyle.itemMenuContainerTouchable}>
                    <View style={ReceptionistHomeStyle.itemMenuContainerTouchableContentFoodType}>
                      ...
                      <Text style={ReceptionistHomeStyle.title}>Danh sách bàn {this.state.outputDiningTableType}:</Text>
        ...
        {this.state.status == 'orderfoodview' ?
          <SafeAreaProvider>
            <View style={ReceptionistHomeStyle.itemDetailOrderListContainer}>
              <Text></Text>
              ...
              <View style={ReceptionistHomeStyle.itemDetailOrderListExtraContainer}>
                ...
                <TouchableOpacity onPress={this.previousItemOrderFoodList}>
                  <Image
                    style={ReceptionistHomeStyle.itemDetailOrderListpreviousButton}
                    source={require('./../../assets/previous.png')}
                  />
                </TouchableOpacity>
              </View>
          ...
          <View style={ReceptionistHomeStyle.container}>
            ...
            <Animated.View
              ...
              <SafeAreaProvider>
                ...
                <View style={ReceptionistHomeStyle.bottomofadddiningtablecontainer}>
                  ...
                  <View style={ReceptionistHomeStyle.itemMenuContainerTouchable}>
                    <View style={ReceptionistHomeStyle.itemMenuContainerTouchableContentFoodType}>
                      ...
                      <Text style={ReceptionistHomeStyle.title}>Danh sách bàn trống:</Text>
        ...
        {this.state.status == 'ordercompleteview' ?
          <SafeAreaProvider>
            <View style={ReceptionistHomeStyle.completeContainer}>
              <Text style={ReceptionistHomeStyle.completeTitle}>Đơn hàng tạo thành công</Text>
              <Text style={ReceptionistHomeStyle.completeText}>Vui lòng chờ xử lí...</Text>
              <Text></Text>
              <TouchableOpacity onPress={() => {
                this.setState({ status: 'loading' })
                setTimeout(function () {
                ...
                <Image
                  style={ReceptionistHomeStyle.completeLogo}
                  source={require('./../../assets/complete.png')}
                />
              </TouchableOpacity>
        ...
        {this.state.status == 'loading' ?
          <SafeAreaProvider>
            ...
            <AnimatedLoader
              ...
              overlayColor=''
              animationStyle={ReceptionistHomeStyle.lottie}
              speed={1.5}
              style={ReceptionistHomeStyle.container}
            >
...
export default connect(mapStateToProps)(ReceptionistHomeScreen);