...
class ReceptionistOrderScreen extends React.Component {
            ...
            for (const element of getDiningTableAll) {
              ...
              fetch(host + ':' + port + orderListUrl + getNewOrder[0].order.id, {
                ...
                .then(dataJson => {
                  ...
                  if (dataJson.diningTables.length > 1) { getdiningTableForm = 'Bàn ghép' }
                  else {
                    getdiningTableForm = 'Bàn đơn';
                  }
                  getDiningTable.push({ id: element.id, diningTable: element, diningTableForm: getdiningTableForm });
      ...
      .then(dataJson => {
        setTimeout(
          () => {
            var getOrder = [];
            for (const element of dataJson) {
              if (element.diningTables.length == 0 && element.type == 'Đơn hàng mới'&&element.status!='Đã thanh toán') {
  ...
  renderItemDetailOrderFoodList = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistOrderStyle.itemDetailOrderCartList}>
        <View>
          <TouchableOpacity
            onPress={() => {
            ...
            <Image
              style={ReceptionistOrderStyle.itemDetailOrderListPlus}
        ...
        <View>
          <Image
            style={ReceptionistOrderStyle.itemDetailOrderListLogo}
            source={{
            ...
            <View style={{ backgroundColor: '#103667', width: '100%', height: '95%', borderRadius: 15, padding: '2%' }}>
              ...
              <View style={ReceptionistOrderStyle.itemDetailOrderListExtraContainer}>
                ...
                <TouchableOpacity onPress={() => { this.setState({ modalFoodCartAdd: false }) }}>
                  <Image
                    style={ReceptionistOrderStyle.itemDetailOrderListpreviousButton}
                    source={require('./../../assets/cancel.png')}
                  />
                </TouchableOpacity>
              </View>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20 }}>
            ...
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}><Text style={ReceptionistOrderStyle.error}>{this.state.errorDrinkModal}</Text></View>
            <Text></Text>
            <Input
            ...
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}>
              <TouchableOpacity onPress={() => { this.addToCart(); }}>
                <Image
                  style={ReceptionistOrderStyle.saveButton}
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20 }}>
            ...
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}><Text style={ReceptionistOrderStyle.error}>{this.state.errorDishModal}</Text></View>
            <Text></Text>
            <Input
              inputStyle={{ fontSize: this.state.windowWidth / 28 }}
              inputContainerStyle={{ backgroundColor: 'white', borderRadius: 10 }}
        ...
        >
          <View style={{ backgroundColor: 'white', borderRadius: 20, padding: '5%' }}>
            ...
            <ScrollView nestedScrollEnabled={false}>
              <DropDownPicker
                listMode="SCROLLVIEW"
                style={ReceptionistOrderStyle.setupItemCenterContainerRowOption}
    ...
    fetch(host + ':' + port + orderListUrl + value, {
      ...
      .then(dataJson => {
        setTimeout(
          () => {
            var getOrder = [];
            if (dataJson.diningTables.length == 0&&dataJson.status!='Đã thanh toán'&&dataJson.type=='Đơn hàng mới')
  ...
  orderDetailView = () => {
    return (
      <Animated.View
        style={[
          ReceptionistOrderStyle.container,
          {
  ...
  renderItemDetailOrderDiningTableList = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistOrderStyle.itemDetailOrderList}>
        <View>
  ...
  renderItemDrinkDetailList = ({ item }) => (
    <TouchableOpacity onPress={() => { }}>
      <View style={ReceptionistOrderStyle.itemDetailList}>
        <View>
        ...
        <View>
          <Image
            style={ReceptionistOrderStyle.itemDetailListLogo}
            source={{
              uri: item.food.urlImage + '/'
            }}
          />
    ...
    <TouchableOpacity onPress={() => { this.orderDetailItem(item) }}>
      <View style={ReceptionistOrderStyle.item}>
        <View style={{ flex: 1 }}>
          ...
          <Text><Text style={{ fontWeight: 'bold' }}>Tên: </Text>{item.diningTable.name}</Text>
          <Text><Text style={{ fontWeight: 'bold' }}>Khu vực: </Text>{item.diningTable.area.name}</Text>
          <Text><Text style={{ fontWeight: 'bold' }}>Hình thức: </Text>{item.diningTableForm}</Text>
      ...
      <SafeAreaProvider>
        ...
        {this.state.statusOderDrinkDetail == 'addview' ?
          <View style={ReceptionistOrderStyle.addExtraItemContainer}>
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}>
              <View>
                <Text style={ReceptionistOrderStyle.titleResourceDrink}>Thêm đồ uống vào đơn hàng: </Text>
            ...
            <View style={ReceptionistOrderStyle.itemMenuContainerTouchable}>
              <View style={ReceptionistOrderStyle.itemMenuContainerTouchableContentFoodType}>
                ...
                <Text style={ReceptionistOrderStyle.title}>Danh sách {this.state.outputCategory}:</Text>
            ...
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}>
              ...
              >
                <Image
                  style={ReceptionistOrderStyle.cart}
      ...
      <SafeAreaProvider>
        ...
        {this.state.statusOderDishDetail == 'addview' ?
          <View style={ReceptionistOrderStyle.addExtraItemContainer}>
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}>
              <View>
                <Text style={ReceptionistOrderStyle.titleResourceDrink}>Thêm món vào đơn hàng: </Text>
      ...
      <SafeAreaProvider>
        ...
        {this.state.statusOderDiningTableDetail == 'addview' ?
          <View style={ReceptionistOrderStyle.addExtraItemContainer}>
            <View style={ReceptionistOrderStyle.setupItemCenterContainer}>
              <View>
                <Text style={ReceptionistOrderStyle.titleResourceDrink}>Thêm bàn vào đơn hàng: </Text>
              </View>
            </View>
            <View style={ReceptionistOrderStyle.itemMenuContainerTouchable}>
              <View style={ReceptionistOrderStyle.itemMenuContainerTouchableContentFoodType}>
        ...
        {this.state.status == 'homeview' ?
          <TabView
            ...
            navigationState={{
              ...
              routes: [
                { key: 'orderDiningTable', title: 'Đặt bàn' },
                { key: 'bringHome', title: 'Mang về' }
              ]
            }}
            renderScene={this.renderScene}
            onIndexChange={() => { if (this.state.tabIndex == 0) this.setState({ tabIndex: 1 }); else { this.setState({ tabIndex: 0 }) } }}
          />
          : null}
