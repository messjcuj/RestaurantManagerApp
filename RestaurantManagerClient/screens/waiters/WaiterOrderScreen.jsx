...
class WaiterOrderScreen extends React.Component {
  ...
  temporaryOrder(){
    ...
    return;
      ...
      Alert.alert(
        "Thông báo",
        "Xác nhận gửi đơn hàng đến quầy thu ngân?",
        [
          {
            text: "Đóng",
            onPress: () => { }
            ...
            text: "Đồng ý", onPress: () => {
              fetch(host + ':' + port + notificationAddUrl, {
                ...
                body: JSON.stringify({
                  ...
                  detail: "Quầy thu ngân nhận được một yêu cầu thanh toán mới",
                  status: false,
                  user: {
                    id: 1
                  }
              ...
              fetch(host + ':' + port + orderUpdateUrl + this.state.dataSingleOrder.id, {
                ...
                body: JSON.stringify({
                  ...
                  status: 'Đang chờ quầy thu ngân xử lý',
                ...
                .then(data => {
                  ...
                  getOrder.status = 'Đang chờ quầy thu ngân xử lý';
          ...
          <View style={WaiterOrderStyle.bottomcontainer}>
            ...
            <View style={WaiterOrderStyle.itemMenuContainerTouchable}>
              <View style={WaiterOrderStyle.itemMenuContainerTouchableContentFoodType}>
                ...
                <Text style={WaiterOrderStyle.title}>Danh sách:</Text>
                ...
                <View style={WaiterOrderStyle.bottomcontainer}>
                      ...
                      <View style={WaiterOrderStyle.itemMenuContainerTouchableContent}>
                        ...
                        >
                          <Image
                            ...
                            source={require('./../../assets/blankDiningTable.png')}
                          />
                          <Text style={WaiterOrderStyle.itemMenuTitle}>Trống</Text>
                        ...
                        >
                          <Image
                            ...
                            source={require('./../../assets/useDiningTable.png')}
                          />
                          <Text style={WaiterOrderStyle.itemMenuTitle}>Đã đặt</Text>
                  ...
                  <View style={WaiterOrderStyle.itemMenuContainerTouchable}>
                    <View style={WaiterOrderStyle.itemMenuContainerTouchableContentFoodType}>
                      ...
                      <Text style={WaiterOrderStyle.title}>Danh sách bàn {this.state.outputDiningTableType}:</Text>
                ...
                <View style={WaiterOrderStyle.bottomofadddiningtablecontainer}>
                  ...
                  <View style={WaiterOrderStyle.itemMenuContainerTouchable}>
                    <View style={WaiterOrderStyle.itemMenuContainerTouchableContentFoodType}>
                      ...
                      <Text style={WaiterOrderStyle.title}>Danh sách bàn trống:</Text>
        ...
        {this.state.status == 'ordercompleteview' ?
          <SafeAreaProvider>
            <View style={WaiterOrderStyle.completeContainer}>
              <Text style={WaiterOrderStyle.completeTitle}>Đơn hàng tạo thành công</Text>
              <Text style={WaiterOrderStyle.completeText}>Vui lòng chờ xử lí...</Text>
              <Text></Text>
              <TouchableOpacity onPress={() => {
                this.setState({ status: 'loading' })
                setTimeout(function () {
