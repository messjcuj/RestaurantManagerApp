...
class WaiterNotificationShowScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            flag: true,
    ...
    orderDiningTablerenderItem = ({ item }) => (
        <View>
            <View style={WaiterNotificationStyle.item}>
                ...
                <View>
                    <Image
                        style={WaiterNotificationStyle.logo}
    ...
    orderDrinkDetailView = () => {
        return (
            <SafeAreaProvider>
                <View style={WaiterNotificationStyle.addExtraItemContainer}>

                    <View style={WaiterNotificationStyle.setupItemCenterContainer}>
                        <Text style={WaiterNotificationStyle.titleResourceDrink}>Thông tin đơn hàng: </Text>
                    ...
                    <View style={WaiterNotificationStyle.setupItemCenterContainer}>
                        <TouchableOpacity onPress={() => { this.setState({ status: 'homeview' }); this.componentDidMount(); }} >
                            <Image
                                style={WaiterNotificationStyle.cancelButton}
    ...
    render() {
        return (
            ...
            <View style={WaiterNotificationStyle.container}>
...
export default connect(mapStateToProps)(WaiterNotificationShowScreen);